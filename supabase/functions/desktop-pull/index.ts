...
Deno.serve(async (req) => {
  try {
    ...
    const [
      ...
      byCompany("customer_future_billing_invoices"),
    ...
    return jsonResponse({
      ...
      customerVehicles: customerVehicles.rows,
      ...
      customerFutureBillingInvoices: customerFutureBillingInvoices.rows,
