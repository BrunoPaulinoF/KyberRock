...
export const KYBERROCK_BRIEFING = [
  ...
  "- Venda para ENTREGA FUTURA: o cadastro do cliente guarda o numero de uma NF-e de faturamento ja",
  "  emitida, POR PRODUTO (a nota de rachao nao vale para a brita; sem produto vale para qualquer um).",
  "  Enquanto ela estiver cadastrada, toda pesagem daquele produto sai com a referencia da nota no cupom",
  "  e nos dados adicionais do pedido enviado ao OMIE. Ela carimba todas as pesagens ate ser removida do",
  "  cadastro — remover a nota e o que encerra a entrega futura.",
