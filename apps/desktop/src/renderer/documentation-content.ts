...
export const documentationSections: DocumentationSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "No fim da tela, a lista Pesagem a pesagem traz as mesmas cargas das faturas numa tabela so — operacao, data, cliente, produto, placa, peso, preco unitario, produto, frete, total, nota fiscal e situacao —, na ordem em que foram feitas. E onde se acha uma carga sem abrir fatura por fatura.",
