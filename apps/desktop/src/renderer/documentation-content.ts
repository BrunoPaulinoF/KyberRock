...
export const documentationSections: DocumentationSection[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Nas planilhas (Excel), peso, valor, quantidade, data e tempo sao numero e data de verdade na celula: da para somar a coluna, tirar media, ordenar por valor e escrever formula direto. O que e identificador — CNPJ/CPF, vale, nota fiscal, codigo do produto, pedido do OMIE e placa — continua como texto, senao o Excel comeria o zero a esquerda e estragaria o numero.",
