...
export const documentationSections: DocumentationSection[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Balanca principal de precos: quando a pedreira tem mais de um computador, o administrador escolhe no painel web qual deles define os precos. Nos demais, preco padrao, preco especial, tabela de preco e valor de frete do cadastro aparecem so para consulta, com um aviso dizendo em qual computador alterar. Cadastre o preco na balanca principal: em segundos ele chega aos outros computadores.",
      "Sem balanca principal escolhida, cada computador continua com o preco que foi digitado nele — e por isso que um preco especial podia existir numa balanca e nao na outra. Se voce ve precos diferentes entre os computadores da pedreira, peca ao administrador para eleger a balanca principal no painel.",
