...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "supabase/functions/{_shared,daily-report-email,financial-report-email,docs-assistant,desktop-download,web-api,desktop-billing-requests,desktop-operation-requests}/*_test.ts"
    ],
